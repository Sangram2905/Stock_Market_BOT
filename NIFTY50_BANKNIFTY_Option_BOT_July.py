...
if float(nf_n50['pChange']) >= 0.01 and float(nf_n50['pChange']) < 0.95 and float(nseindexs) > 0.0 and float(nf_indiavix['pChange']) < 0.0:
...
print('',file=open("NSEmarket.txt", "a"))  
print('NIFTY BANK index current value is {} and percent change is {} '.format(nf_bank['lastPrice'],nf_bank['pChange']),file=open("NSEmarket.txt", "a")) 
